...
/**
 * Twilio SMS scheduling — intentionally disabled while ACCOUNTABILITY_CHANNEL !== 'sms'.
 * Full Twilio implementation is preserved in git history / unused helpers under _shared/twilio.ts.
 */
Deno.serve(async (req) => {
  ...
  try {
    ...
    // SMS path is gated above; this branch is reserved for a future Twilio revival.
    return jsonResponse({
      ok: false,
      disabled: true,
